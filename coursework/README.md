...
This folder contains course descriptions from my **B.Eng. in Acoustic Engineering** at **AGH University of Science and Technology** (2021–2025).  
The included document (`course_descriptions.pdf`) summarizes the main courses, learning outcomes, and technical scope of the program.

Below is a concise overview of the most relevant subject areas:
...
- **Methods and Software Tools in Acoustics** – Numerical simulation, acoustic field modeling, and automation using Python and MATLAB.  
- **Programming in LabVIEW** – Development of data acquisition and control applications for measurement systems.
...
- **Musical Acoustics** – Sound generation and perception in musical instruments.  
- **Audio Engineering and Live Sound** – Sound reinforcement systems, signal routing, and room equalization.
